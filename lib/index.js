...
export class ShippoService {
    constructor(options, app) {
        ...
        if (!shippoKey) {
            throw new GeneralError('options.shippoKey is required for new ShippoService()');
        }
        if (!resource || objectHas(shippo, resource)) {
            throw new GeneralError(`${resource} is invalid options.resource for new ShippoService()`);
        }
